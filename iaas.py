...
off="sudo qrencode -s 16*16 -o {}_{}.png 'http://{}:{}'".format(os,vnc,b[0],web)
...
commands.getoutput(vm)
#print "vm executed"
commands.getoutput(web1)
#print "websockify execeuted"
#print commands.getoutput('sudo mkdir /root/Desktop/apache')
#print "<a href='/QRCode/{}_{}.png' target='_blank'>".format(os,vnc)

print "<meta HTTP-EQUIV='refresh' content='0; url=http://{}/pankaj/novnc/vnc_auto.html?ip={}&port={}'/>".format(b[0],b[0],web)
